        ...
        "input_stream_list":[
            ...
            {   
                ...
                "layout_params":
                {
                    ...
                    #模板510小画面1默认image_width为背景width/3
                    #模板510小画面1默认image_height为背景height/3
                    #模板510小画面1默认location_x为20
                    #模板510小画面1默认location_y为20
                    "image_layer": 2
                }
            },  
            {   
                ...
                "layout_params":
                {
                    #模板510小画面2默认image_width为背景width/3
                    #模板510小画面2默认image_height为背景height/3
                    #模板510小画面2默认location_x为背景width-20-流width
                    #模板510小画面2默认location_y为背景height-20-流height
                    "image_layer": 3
                }
            },  
            {   
                ...
                "layout_params":
                {
                    #模板510小画面3默认image_width为背景width/3
                    #模板510小画面3默认image_height为背景height/3
                    #模板510小画面3默认location_x为背景width-20-流width
                    #模板510小画面3默认location_y为背景20
                    "image_layer": 4
                }
            },  
            {   
                ...
                "layout_params":
                {
                    #模板510小画面4默认image_width为背景width/3
                    #模板510小画面4默认image_height为背景height/3
                    #模板510小画面4默认location_x为背景20
                    #模板510小画面4默认location_y为背景height-20-流height
                    "image_layer": 5
                }
            }
               ]
