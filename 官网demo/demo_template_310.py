        ...
        "input_stream_list":[
            ...
            {   
                ...
                "layout_params":
                {
                    ...
                    #模板310小画面1默认image_width为背景width/3
                    #模板310小画面1默认image_height为背景height/3
                    #模板310小画面1默认location_x为20
                    #模板310小画面1默认location_y为20
                    "image_layer": 2
                }
            },  
            {   
                ...
                {
                    #模板默认image_width和image_height与背景流宽、高，该流原始宽、高等因素相关，以下说明为大致值，并不完全准确
                    #模板310小画面2默认image_width为背景width/3
                    #模板310小画面2默认image_height为背景height/3
                    #模板310小画面2默认location_x为背景width-20-流width
                    #模板310小画面2默认location_y为背景height-20-流height
                    "image_layer": 3
                }
            }
               ]
