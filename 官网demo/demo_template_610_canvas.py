...
if '__main__' == __name__:
    ...
    content = json.dumps({
        ...
        "input_stream_list":[
            {
                "input_stream_id":"stream",#修改为画布id
                "layout_params":
                {   
                    # 作为背景的画布不填image_width和image_height，则
                    # 使用image_layer最小的流width和height
                    "image_layer": 1,
                    "input_type":3,
                    "color":"0x000000",
                }   
            ...
            {   
                "input_stream_id":"stream_lewis01",#修改为输入流2的id
                "layout_params":
                {
            ...
            {   
                "input_stream_id":"stream_lewis02",#修改为输入流3的id
                "layout_params":
                {
            ...
            {   
                "input_stream_id":"stream_lewis03",#修改为输入流4的id
                "layout_params":
                {
            ...
            {   
                "input_stream_id":"stream_lewis04",#修改为输入流5的id
                "layout_params":
                {
            ...
            {   
                "input_stream_id":"stream_lewis05",#修改为输入流6的id
                "layout_params":
                {
                    #模板610小画面4默认image_width为背景width/3
                    #模板610小画面4默认image_height为背景height/3
