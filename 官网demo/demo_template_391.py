...
demo说明：使用模板391
注意：
    1.input_stream_list只能有三条可视输入，即音视频(input_type为0)、图片(2)、画布(3)、纯视频流(5)
        ...
        "input_stream_list":[
            ...
            {   
                ...
                "layout_params":
                {
                    ...
                    #模板391小画面1默认image_width为背景width/2
                    #模板391小画面1默认image_height为背景height/2
                    #模板391小画面1默认location_x为(背景width-流width-20)/2
                    #模板391小画面1默认location_y为10
                    "image_layer": 2
                }
            },  
            {   
                ...
                {
                    #模板默认image_width和image_height与背景流宽、高，该流原始宽、高等因素相关，以下说明为大致值，并不完全准确
                    #模板391小画面2默认image_width为背景width/2
                    #模板391小画面2默认image_height为背景height/2
                    #模板391小画面2默认location_x为(背景width-流width-20)/2
                    #模板391小画面2默认location_y为流height+20
                    "image_layer": 3
                }
            }
               ]
